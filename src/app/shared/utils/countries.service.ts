...
export class CountryService {
  ...
  getCountryByCode = (code: any) => {
    const filter = countryList.filter((country) => {
      return (
        country.alpha2Code === code ||
        country.alpha3Code === code ||
        country.callingCodes.includes(parseInt(code, 10) + "") ||
        country.currencies.filter((curr) => curr.code === code).length > 0
      );
    });
  ...
  generateReference = (merchant: any, wallet: any) => {
